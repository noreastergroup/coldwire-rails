...
// A surface this app describes for itself, as opposed to an asset or somebody else's file.
// What sets the two apart is whether the URL outlives its contents: an asset carries a digest
// and a new build is a new address, while a surface keeps its address and changes underneath
// it. So these are the ones worth refetching when there is a network.
